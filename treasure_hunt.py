...
type("\nOkay, So now you've reached the island.\nYou are very hungry and there are some apples and oleanders grown on the trees. One of them is poisonous! What would you decide to eat ?\n")
c2 = input()
